@php
    ...
    if ($member_countt <= 3) {
        $rate = $amount;
    } elseif ($member_countt >= 4 && $member_countt <= 6) {
        $rate = $rate_2;
    } else {
        $rate = $rate_3;
    }
    $total_amount = $rate * $member_countt;
            ...
            <table width="100%">
                ...
                <tr>
                    <td style="padding: 20px 0">
                        ...
                        <p>
                            We have successfully received your case submission from <b>{{ $organization }}</b> for the
                            case titled
                            <b>{{ $category }}</b>.
                        </p>
                        <p>
                            Your submission has been reviewed, and here are the details of the primary contact and
                            associated members:
                        </p>
